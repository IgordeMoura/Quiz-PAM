...
export default function Edit() {
    ...
    const carregarPergunta = () => {
        db.transaction(tx => {
            ...
            tx.executeSql('SELECT COUNT (id) As Contagem FROM perguntas;', [] , (_, { rows }) => {
                let registros = rows._array [0];
                setRegistros(registros.Contagem);
            })
        });
    };
    ...
    return(
        <View style={Style.container}>
            ...
            <View style={Style.centralizando}>
                <Text>Total de Registros: {registros}</Text>
            </View>
            <View style={Style.conteudo}>
                ...
                <View style={Style.liBotoes}>
                    <Button title='atualizar pergunta' onPress={atualizarPergunta} style={Style.botoes} color={'green'}/>
